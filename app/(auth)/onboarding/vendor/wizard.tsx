 ...
 * (Business / First station / Bank). Kept so the auth Stack registers
 * the route and Phase 2's bootstrap router has somewhere to land.
 */
export default function VendorWizardStub() {
    ...
    <AuthScreenContainer>
      <View style={styles.wrap}>
        ...
        <Text style={{ color: theme.fgMuted, marginTop: 8 }}>
          The 3-step business / station / bank wizard lands in Phase 3.
        </Text>
      </View>
    </AuthScreenContainer>
  );
